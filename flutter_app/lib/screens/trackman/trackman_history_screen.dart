...
import 'trackman_history_details_screen.dart';
          ...
          : _history.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final historyItem = Map<String, dynamic>.from(item);
                    historyItem['assignedStr'] = assignedStr;
                    historyItem['unassignedStr'] = unassignedStr;
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => TrackmanHistoryDetailsScreen(historyItem: historyItem),
                          ),
                        );
                      },
                      child: Container(
